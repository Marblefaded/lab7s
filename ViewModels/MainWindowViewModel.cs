...
namespace lab7s.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Ситников Владимир Михайлович","2","2","2","2","2","2","2",false),
                new Note("Бебра Валентин Игоревич","1","1","1","1","1","1","1",false),
                new Note("Тараканчиков Александр Александрович","1","0","0","0","0","0","0",false),
            };
        }
